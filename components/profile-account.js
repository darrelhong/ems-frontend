...
const MyAccount = () => {
  ...
  const mutateAccDetail = useMutation((data) =>
    api.post('/api/partner/update', data, {
        onSuccess: () => {
          console.log("3");
          queryClient.invalidateQueries(['user', user?.id.toString()]);
                        ...
                        <div className="account-details-form">
                          ...
                          <form id="account-details-form" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="form-group">
                                ...
                                <Form.Control  name="businesscategory" as="select" onChange={onChangeBizCategory.bind(this)}>
                            ...
                            <Alert show={showAccNotSaved} variant="danger" onClose={() => setAccNotSaved(false)} dismissible>
                               {accFailed}                         
                            </Alert>
