  ...
  return (
    <div>
      ...
      <Menu
        ...
        onClose={handleClose}
      >
        <div className="ml-4" style={{ fontSize: '11', fontWeight: 'bold' }}>
          Toggle Visibility:
        </div>
        <MenuItem>
          <Switch
            checked={hideState.hideBoth}
        ...
        <MenuItem>
          <Switch
            checked={hideState.hideFromAttendee}
            onClick={toggleVisibility}
            name="hideFromAttendee"
          />
          Show to Business Partners / Hide from Attendees
        </MenuItem>
        <MenuItem>
          <Switch
            checked={hideState.showBoth}
            onClick={toggleVisibility}
            name="showBoth"
          />
          Show to Business Partners and Attendees
        </MenuItem>
      </Menu>
    </div>
  );
