      ...
      <Col lg={4} sm={6} className="space-mb--50">
        <div className="product-list">
          <div className="product-list__image">
            <Link href="/organiser/event/1">
              <a>
                <img
                  src="https://image.freepik.com/free-vector/cute-avocado-cartoon-hand-drawn-style_42349-476.jpg"
                  alt="event_image"
                />
              </a>
            </Link>
            ...
            <div className="d-flex justify-content-between">
              <div className="product-price">
                ...
                <span className="rating-num">
                  {' '}
                  {`Sales End Date: ${formatDate(event.salesEndDate)}`}{' '}
                </span>
              </div>
            </div>
            <div className="product-description">{event.descriptions}</div>

            <div>
              <span>
                <ProgressBar now={60} label="60%" />
              </span>
              <span>{event.ticketCapacity}</span>
            </div>
